...
use App\Enums\Cemetery\BurialRightStatus;
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('burial_rights', function (Blueprint $table) {
            ...
            $table->foreignId('crypt_id')->nullable()->constrained()->nullOnDelete();
        ...
        DB::statement(
            'ALTER TABLE burial_rights
            ADD CONSTRAINT burial_rights_single_location
            CHECK (
                ((plot_id IS NOT NULL)::int +
                 (crypt_id IS NOT NULL)::int +
                 (niche_id IS NOT NULL)::int) = 1
            )'
        );
    }
